...
export const NAV_ITEMS: NavItem[] = [
  { to: "/", label: "Inicio", icon: LayoutDashboard, roles: ["ADMIN", "OPERATOR", "AUDITOR"] },
  ...
  { to: "/executions/new", label: "Nueva ejecución", icon: PlayCircle, roles: ["ADMIN", "OPERATOR"] },
  { to: "/executions", label: "Validaciones", icon: ListChecks, roles: ["ADMIN", "OPERATOR", "AUDITOR"] },
