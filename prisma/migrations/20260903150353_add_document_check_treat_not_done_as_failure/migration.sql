...
INSERT INTO "new_document_check_scoring_config" ("categoryWeights", "id", "passThreshold", "updatedAt") SELECT "categoryWeights", "id", "passThreshold", "updatedAt" FROM "document_check_scoring_config";
